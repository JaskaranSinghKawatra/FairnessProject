...
class CustomMLPClassifier(MLPClassifier):
    def fit(self, X, y, sample_weight=None):
        # Ignore sample_weight and just use the superclass's fit method
        return super().fit(X, y)



def neural_network_demographic_parity_reductions(df, target_variable, sensitive_attribute, learning_rate, epsilon, num_epochs, batch_size):
    ...
    estimator = Pipeline(
        steps=[
            ...
            ("classifier", CustomMLPClassifier(**mlp_params)),
        ]
    )
